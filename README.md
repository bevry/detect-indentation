...
``` typescript
import pkg from 'https://unpkg.com/detect-indentation@^5.10.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.pika.dev/detect-indentation/^5.10.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/detect-indentation@^5.10.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/detect-indentation@5.10.0'
</script>
```
