...
<span class="badge-travisci"><a href="http://travis-ci.com/bevry/detect-indentation" title="Check this project's build status on TravisCI"><img src="https://img.shields.io/travis/com/bevry/detect-indentation/master.svg" alt="Travis CI Build Status" /></a></span>
...
<li>Import: <code>import * as pkg from ('detect-indentation')</code></li>
<li>Require: <code>const pkg = require('detect-indentation')</code></li>
</ul>
...
<ul><li><code>detect-indentation</code> aliases <code>detect-indentation/source/index.js</code></li>
<li><code>detect-indentation/source/index.js</code> is <a href="https://en.wikipedia.org/wiki/ECMAScript#ES.Next" title="ECMAScript Next">ESNext</a> source code for <a href="https://nodejs.org" title="Node.js is a JavaScript runtime built on Chrome's V8 JavaScript engine">Node.js</a> with <a href="https://nodejs.org/dist/latest-v5.x/docs/api/modules.html" title="Node/CJS Modules">Require</a> for modules</li>
<li><code>detect-indentation/edition-browsers/index.js</code> is <a href="https://en.wikipedia.org/wiki/ECMAScript#ES.Next" title="ECMAScript Next">ESNext</a> compiled for web browsers with <a href="https://nodejs.org/dist/latest-v5.x/docs/api/modules.html" title="Node/CJS Modules">Require</a> for modules</li></ul>
...
<ul><li><a href="http://balupton.com">Benjamin Lupton</a> — <a href="https://github.com/bevry/detect-indentation/commits?author=balupton" title="View the GitHub contributions of Benjamin Lupton on repository bevry/detect-indentation">view contributions</a></li>
<li><a href="http://github.com/apps/dependabot-preview">dependabot-preview[bot]</a> — <a href="https://github.com/bevry/detect-indentation/commits?author=dependabot-preview[bot]" title="View the GitHub contributions of dependabot-preview[bot] on repository bevry/detect-indentation">view contributions</a></li></ul>
