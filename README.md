...
[Complete API Documentation.](http://master.detect-indentation.bevry.surge.sh/docs/index.html)
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/detect-indentation@4.2.0'
</script>
```
...
<ul><li><code>detect-indentation</code> aliases <code>detect-indentation/index.js</code> which uses the <a href="https://github.com/bevry/editions" title="You can use the Editions Autoloader to autoload the appropriate edition for your consumers environment">Editions Autoloader</a> to automatically select the correct edition for the consumer's environment</li>
